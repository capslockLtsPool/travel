...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for JSON-RPC connections on <port> (default: 7655)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 7654 or testnet: 17654)"),
